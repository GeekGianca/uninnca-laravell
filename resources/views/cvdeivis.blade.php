...
<header>
    <div class="profile-page sidebar-collapse">
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary">
            <div class="container">
                <div class="navbar-translate"><a class="navbar-brand" rel="tooltip">Mi hoja de vida</a>
...
<div class="page-content">
    <div>
            ...
            <div class="wrapper">
                <div class="page-header page-header-small" filter-color="green">
                    <div class="page-header-image" data-parallax="true"
                         style="background-image: url({{asset('images/cc-bg-1.jpg')}})"></div>
                    <div class="container">
                        <div class="content-center">
                            <div class="cc-profile-image"><a href="#"><img src="{{asset('images/Deivis.png')}}"
                                                                           alt="Image"/></a></div>
                            <div class="h2 title">Deivis Javier Miranda Ramos</div>
                            <br>
                            <p class="category text-white">Desarrollador Web, Desarrollador Java, Bases de datos</p>
                        </div>
                    </div>
                    <div class="section">
                        <div class="container">
                            <div class="button-container"><a class="btn btn-default btn-round btn-lg btn-icon"
                                                             href="https://www.facebook.com/deivis.j.miranda/"
                                                             rel="tooltip" title="Sigueme en Facebook"><i
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="card-body">
                                ...
                                <p>Hola Soy Deivis Miranda</p>
                                <p>Persona activa, dedicada a sus actividades laborales, amable ante sus compañeros de
                                    trabajo y demas, </p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                            <div class="card-body">
                                <div class="h4 mt-0 title">Informacion basica</div>
                                <div class="row">
                                    <div class="col-sm-4"><strong class="text-uppercase">Edad:</strong></div>
                                    <div class="col-sm-8">29 Años</div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-sm-4"><strong class="text-uppercase">Correo electronico:</strong>
                                    </div>
                                    <div class="col-sm-8">deivisj92@gmail.com</div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-sm-4"><strong class="text-uppercase">Celular:</strong></div>
                                    <div class="col-sm-8">301-372-1614</div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-sm-4"><strong class="text-uppercase">Direccion:</strong></div>
                                    <div class="col-sm-8">Carrera 149c # 143-28. Localidad suba, barrio bilbao</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="section" id="skill">
            <div class="container">
                <div class="h4 text-center mb-4 title">Mis habilidades</div>
                <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="progress-container progress-primary"><span
                                        class="progress-badge">Java</span>
                                    <div class="progress">
                            ...
                            <div class="col-md-6">
                                <div class="progress-container progress-primary"><span class="progress-badge">Java Spring boot</span>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-primary" data-aos="progress-full"
                                             data-aos-offset="10" data-aos-duration="2000" role="progressbar"
                                             aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
                            ...
                            <div class="col-md-6">
                                <div class="progress-container progress-primary"><span class="progress-badge">Angular Cli</span>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-primary" data-aos="progress-full"
                                             data-aos-offset="10" data-aos-duration="2000" role="progressbar"
                                             aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
                            ...
                            <div class="col-md-6">
                                <div class="progress-container progress-primary"><span class="progress-badge">BD Oracle, MySQL</span>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-primary" data-aos="progress-full"
                                             data-aos-offset="10" data-aos-duration="2000" role="progressbar"
                                             aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
                    ...
                    <div class="row">
                        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50"
                            ...
                            <div class="card-body cc-experience-header">
                                <p>Sep. 2019 – Ene. 2020</p>
                                <div class="h5">AgaSoft E.U.</div>
                            </div>
                        </div>
                        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                            <div class="card-body">
                                <div class="h5">Analista de sistemas</div>
                                <p>Desarrollador de software y consultor de bases de datos en lenguajes Oracle
                                    PL/SQL.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50"
                            ...
                            <div class="card-body cc-experience-header">
                                <p>Sep. 2019 – Ene. 2020</p>
                                <div class="h5">Colmena Fiduciaria</div>
                            </div>
                        </div>
                        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                            <div class="card-body">
                                <div class="h5">Web Developer</div>
                                <p>Desarrollo en Java, programación orientado a objeto, manejo absoluto del Framework
                                    Spring contrayendo APIs Rest, microservicios para agiliza, resolver y manejar
                                    problemas, como también me he desempeñado en desarrollo con Angular 7, tengo mucha
                                    experiencia con desarrollo de bases de datos en Oracle como los que son la creación
                                    Procesos, funciones, Vistas, tipos. Experiencia en manejo de bases de datos SQL
                                    Server, Experiencia absoluta en bootstrap 4 para desarrollos de Front.
                                    Actualmente soy el encargado de desarrollar una página web interna de la fiduciaria
                                    donde estoy almacenando información de negocios fiduciaria, he construido APIs en
                                    Spring para interactuar entre una base de datos SQL server y una base de datos
                                    Oracle, lo que se hace es restringir datos pertenecientes a listas restrictivas. Y
                                    no permitir vinculación de clientes en la base de datos.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="row">
                        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50"
                            ...
                            <div class="card-body cc-experience-header">
                                <p>Feb. 2021</p>
                                <div class="h5">Periferia It Group</div>
                            </div>
                        </div>
                        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                            <div class="card-body">
                                <div class="h5">Consultor</div>
                                <p>Desarrollador java dentro de la empresa, angular para front, asignado para
                                    desarrollos de software a clientes bancarios.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="section">
            <div class="container cc-education">
                <div class="h4 text-center mb-4 title">Educacion</div>
                <div class="card">
                    <div class="row">
                        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50"
                             data-aos-duration="500">
                            <div class="card-body cc-education-header">
                                <p>2013 - 2019</p>
                                <div class="h5">Pregrado</div>
                            </div>
                        </div>
                        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                            <div class="card-body">
                                <div class="h5">Ingeniero de sistemas y telecomunicaciones</div>
                                <p class="category">Universidad de Cordoba - Colombia</p>
                                <p>Profesionales con alto nivel científico capaces de generar y aplicar los
                                    conocimientos de las tecnologías en la solución de los problemas a nivel local,
                ...
                <div class="card">
                    <div class="row">
                        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50"
                            ...
                            <div class="card-body cc-education-header">
                                <p>2021</p>
                                <div class="h5">Postgrado</div>
                            </div>
                        </div>
                        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                            <div class="card-body">
                                <div class="h5">Especializacion en ingenieria de software</div>
                                <p class="category">Universidad INCCA de Colombia</p>
                                <p></p>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="footer">
        <div class="h4 title text-center">Deivis Miranda</div>
